  ...
  return (
    <>
      <div className="relative flex md:flex-row flex-col justify-evenly items-center">
        ...
        />
        <div className="bg-white text-[#3C5480] w-80 h-96 space-y-4 shadow-2xl px-6 py-16 rounded-2xl z-10">
        ...
        <div className="bg-white text-[#3C5480] w-80 h-96 space-y-4 shadow-2xl px-6 py-16 rounded-2xl">
